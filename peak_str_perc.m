...
dinter = (1 - inter./inter(1))*100;
drad_peak = (1 - rad_peak./rad_peak(1))*100;
dcirc_peak = (1 - circ_peak./circ_peak(1))*100;
...
% 
% legend({'Interficial str', 'Peak Radial Str', 'Peak Circ. Str'}, 'Location', 'northwest')
% xlabel('Time [y]')
% ylabel('% Change')
% grid on
% set(gca, 'Fontsize', 12)
